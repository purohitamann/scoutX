...
//           <button className="mt-2 px-4 py-2 rounded bg-blue-600 text-white">Change Password</button>
//         </div>
//         <div className="mt-4">
...
//                 className={`${enabled[type as keyof typeof enabled] ? 'bg-blue-600' : 'bg-gray-300'} relative inline-flex h-6 w-11 items-center rounded-full`}
//               >
...
//         <input type="text" placeholder="Interview Time Slots (e.g. 10am-12pm)" className="w-full p-2 border rounded mb-2" />
...
//             className={`${enabled.calendarSync ? 'bg-blue-600' : 'bg-gray-300'} relative inline-flex h-6 w-11 items-center rounded-full`}
//           >
...
//         <input type="text" placeholder="API Key or OAuth" className="w-full p-2 border rounded mb-2" />
//         <select className="p-2 border rounded w-full mb-2">
//           <option>Sync Frequency: Real-time</option>
//           <option>Sync Frequency: Daily</option>
//           <option>Sync Frequency: Weekly</option>
//         </select>
//         <input type="text" placeholder="Filter Roles (e.g. Software Engineer)" className="w-full p-2 border rounded" />
//       </div>

//       {/* Automated Messaging */}
//       <div className="border rounded-2xl shadow p-4">
//         <h2 className="text-xl font-semibold mb-4">Automated Messaging</h2>
//         <textarea placeholder="Rejection Email Template" className="w-full p-2 border rounded mb-2" />
//         <textarea placeholder="Interview Invite Template" className="w-full p-2 border rounded mb-2" />
//         <input type="text" placeholder="Email Signature" className="w-full p-2 border rounded" />
//       </div>
...
//             className={`${enabled.anonymizeData ? 'bg-blue-600' : 'bg-gray-300'} relative inline-flex h-6 w-11 items-center rounded-full`}
//           >
...
//           </Switch>
//         </div>
//         <p className="text-sm text-gray-600 mt-2">We comply with GDPR to protect your candidate data.</p>
//       </div>

//       <button className="px-6 py-3 rounded bg-green-600 text-white shadow-lg">Save Changes</button>
//     </div>
//   );
// }
